const posts = [
	...
	// 	content: ``
	// }
	//<p class="article__subtitle part1"></p>
	...
	//<a href="link" rel="noreferrer" target="_blank" class="link"></a>
	{
		...
		content: `
			<p class="article__subtitle part1">Part I</p>
			...
			<p class="article__subtitle part2">Part II</p>
			...
			<p class="article__subtitle part3">Part III</p>
			...
			<p class="article__subtitle part4">Part IV</p>
			...
			<p class="article__subtitle part5">Part V</p>
	...
	},
	{
		...
		content: `
			...
			<p class="article__subtitle part1">This is how to not write your feedback letter.</p>
	...
	},
	{
		...
		content: `
			...
			<p class="article__subtitle part1">Prehistory</p>
			...
			<p class="article__subtitle part2">History</p>
			...
			<p class="article__subtitle part3">1. Performance and user experience.</p>
			...
			<p class="article__subtitle part4">2. Wrong triggering.</p>
			...
			<p class="article__subtitle part5">Conclusion</p>
